...
public class FishTank {
  public static void main(String[] args) {
    ...
    // - Clownfish, gains 1 gram when feed and has stripe color.
    // - Tang, gains 1 grams when feed and can suffer short-term memory loss.
    // - Koi, gains 2 grams when feed.
    ...
    // increases the weight of every fish with the amount of grams they gain when feed.
